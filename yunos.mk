...
LOCAL_CMD_CONFIGURE:= \
       ...
       export INTEL_LIBS="-L$${buildroot}/usr/lib/ -ldrm_intel -ldrm"; \
       export PTHREADSTUBS_LIBS="-L$${buildroot}/usr/lib/ -lpthread-stubs"; \
       export WAYLAND_SERVER_LIBS="-L$${buildroot}/usr/lib/ -lwayland-client -lwayland-server"; \
       export VALGRIND_CFLAGS="-I$${YUNOS_ROOT}/third_party/valgrind/include -I$${YUNOS_ROOT}/third_party/valgrind/memcheck"; \
       ./autogen.sh \
       --host=$(XMAKE_TOOLCHAIN_NAME) \
